...
```{r figure-boxplots, echo=FALSE, out.width='0.98\\columnwidth', fig.cap="Boxplots on the distribution of the numeric attributes"}
...
```
```{r, pairs-numeric, echo=FALSE, out.width='0.98\\textwidth', fig.cap="Pairs of all numeric attributes"}
