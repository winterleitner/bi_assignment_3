...
error_of_95_abs <- sort(relative_error_abs)[floor(nrow(relative_error_abs)*0.95)]
mean_error_of_95_abs <- mean(sort(relative_error_abs)[sort(relative_error_abs)<error_of_95_abs])
