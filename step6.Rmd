...
* increase revenues by missing out on fewer chances to buy used cars (more cars resold via the plattform instead of directly to other buyers)
...
The following criterium needs to be met by the predicion:
...
* People aborting the process when the estimate is much lower than their expactation
