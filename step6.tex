...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{car_data <-}\StringTok{ }\NormalTok{car_data[car_data}\OperatorTok{$}\NormalTok{age }\OperatorTok{>=}\StringTok{ }\DecValTok{0}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{car_data <-}\StringTok{ }\NormalTok{car_data[}\OperatorTok{!}\NormalTok{(car_data}\OperatorTok{$}\NormalTok{mileage }\OperatorTok{<}\StringTok{ }\DecValTok{1000} \OperatorTok{&}\StringTok{ }\NormalTok{car_data}\OperatorTok{$}\NormalTok{age }\OperatorTok{>}\StringTok{ }\DecValTok{5}\NormalTok{), ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{nrow}\NormalTok{(car_data[car_data}\OperatorTok{$}\NormalTok{mpg }\OperatorTok{>}\StringTok{ }\DecValTok{60}\NormalTok{, ])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(car_data[car_data}\OperatorTok{$}\NormalTok{fuelType }\OperatorTok{==}\StringTok{ "Petrol"}\NormalTok{, ]}\OperatorTok{$}\NormalTok{mpg)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    0.30   43.50   51.40   50.83   58.90  166.20
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(car_data[car_data}\OperatorTok{$}\NormalTok{fuelType }\OperatorTok{==}\StringTok{ "Hybrid"}\NormalTok{, ]}\OperatorTok{$}\NormalTok{mpg)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    1.10   70.60   76.40   89.05   85.60  470.80
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{types <-}\StringTok{ }\KeywordTok{distinct}\NormalTok{(car_data, car_data}\OperatorTok{$}\NormalTok{fuelType)[, }\DecValTok{1}\NormalTok{]}\OperatorTok{$}\StringTok{`}\DataTypeTok{car_data$fuelType}\StringTok{`}
\ControlFlowTok{for}\NormalTok{ (type }\ControlFlowTok{in}\NormalTok{ types) \{}
\NormalTok{  outliers <-}\StringTok{ }\KeywordTok{boxplot}\NormalTok{(car_data[car_data}\OperatorTok{$}\NormalTok{fuelType }\OperatorTok{==}\StringTok{ }\NormalTok{type, ]}\OperatorTok{$}\NormalTok{mpg, }\DataTypeTok{plot=}\OtherTok{FALSE}\NormalTok{)}\OperatorTok{$}\NormalTok{out}
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{length}\NormalTok{(outliers) }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) \{}
\NormalTok{    car_data <-}\StringTok{ }\NormalTok{car_data[}\OperatorTok{-}\KeywordTok{which}\NormalTok{(car_data}\OperatorTok{$}\NormalTok{mpg }\OperatorTok{%in%}\StringTok{ }\NormalTok{outliers }\OperatorTok{&}\StringTok{ }\NormalTok{car_data}\OperatorTok{$}\NormalTok{fuelType }\OperatorTok{==}\StringTok{ }\NormalTok{type),]}
\NormalTok{  \}}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
