...
\begin{figure}
\includegraphics[width=0.98\columnwidth]{step6_files/figure-latex/figure-boxplots-1} \caption{This is how great Tribute gets over time}\label{fig:figure-boxplots}
\end{figure}
