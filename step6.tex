...
\begin{figure}
\includegraphics[width=0.98\columnwidth]{step6_files/figure-latex/figure-boxplots-1} \caption{Boxplots on the distribution of the numeric attributes}\label{fig:figure-boxplots}
\end{figure}
...
\end{figure}
\begin{figure}
\includegraphics[width=0.98\textwidth]{step6_files/figure-latex/pairs-numeric-1} \caption{Pairs of all numeric attributes}\label{fig:pairs-numeric}
\end{figure}
